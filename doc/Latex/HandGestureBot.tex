...
The \textit{HandGestures2Bot} project was developed using an iterative, sprint-based workflow inspired by agile methodologies. Planning and progress tracking were organized via a Trello board structured into backlog, in-progress, done, impediments, and risks columns. The sprint history below is presented chronologically, from earliest to latest.

\subsubsection{Sprint 1 -- Project Concept and Planning (October 2025)}
The initial sprint focused on defining the project vision, core use cases, and system architecture. Gesture-based robot control scenarios and safety requirements such as an emergency stop were specified. Key technology decisions were made, including Flutter for the mobile app, MediaPipe for gesture recognition, and ROS2 for robot control. The overall communication pipeline from mobile client to robot was defined.

\subsubsection{Sprint 2 -- Gesture Recognition and Mobile Application (November 2025)}
This sprint concentrated on developing the Flutter-based mobile application and integrating MediaPipe for real-time hand gesture recognition using native Android and iOS modules. Basic gestures such as fist and open palm were implemented and validated. Initial WebSocket communication from the app was prepared, and early latency and performance challenges were identified.

\subsubsection{Sprint 3 -- ROS2 Backend and WebSocket Control (Late November 2025)}
The focus shifted to the robot-side implementation. A custom ROS2 \texttt{ament\_python} package was created, including a WebSocket server that converts incoming gesture commands into \texttt{/cmd\_vel} messages using \texttt{geometry\_msgs/Twist}. Gesture-based control was successfully tested in Gazebo simulation and on real TurtleBot3 hardware. A watchdog-based emergency stop mechanism was implemented for safety.

\subsubsection{Sprint 4 -- Integration and Hardware Testing (December 2025)}
This sprint emphasized system integration and validation. The TurtleBot3 hardware environment was prepared and tested, including network configuration and deployment stability. The complete gesture-to-motion pipeline was verified under real Wi-Fi conditions. Network instability and power-related issues were identified, and mitigation strategies were planned.

\subsubsection{Sprint 5 -- Extension Analysis and Future Work (December 2025)}
The final sprint explored system extensibility, particularly the integration of voice-based control. Architectural requirements and limitations for cloud-based voice services were analyzed. While voice control was not fully implemented, the existing architecture was confirmed to be extensible. At this stage, all core objectives for gesture-based robot control were completed, and remaining features were classified as future work.
...
\hline
\texttt{- flutterapp\slash pubspec.yaml} & Coauthor & Author & & Coauthor \\
\texttt{- flutterapp\slash lib\slash main.dart} & Author & Coauthor & & \\
\texttt{- flutterapp\slash lib\slash models\slash dance\_move.dart} & Author & & & Author \\
\texttt{- flutterapp\slash lib\slash models\slash obstacle\_status.dart} & Author & & & \\
\texttt{- flutterapp\slash lib\slash services\slash dance\_music\_controller.dart} & & & & Author \\
\texttt{- flutterapp\slash lib\slash services\slash dance\_service.dart} & Author & & & Author\\
\texttt{- flutterapp\slash lib\slash services\slash gesture\_service.dart} & & Author & & Author\\
\texttt{- flutterapp\slash lib\slash services\slash native\_bluetooth\_service.dart} & Author & Coauthor & & \\
\texttt{- flutterapp\slash lib\slash services\slash obstacle\_sensor\_service.dart} & Author & & & \\
\texttt{- flutterapp\slash lib\slash services\slash robot\_service.dart} & Author & & & \\
...
\texttt{- flutterapp\slash lib\slash views\slash camera\_view.dart} & Author & Coauthor & & Coauthor\\
\texttt{- flutterapp\slash lib\slash views\slash obstacle\_visualization\_widget.dart} & Author & & & \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_pages\slash bluetooth\_setup\_page.dart} & Author & & & \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_pages\slash create\_dance\_view.dart} & Author & & & Author \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_pages\slash hand\_gestures\_page.dart} & Author & Coauthor & & Coauthor \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_pages\slash robot\_connection\_page.dart} & Author & & & \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_pages\slash save\_gesture\_view.dart} & Author & Coauthor & & Coauthor \\
\texttt{- flutterapp\slash lib\slash views\slash settings\_view.dart} & Author & & & Coauthor \\
...
\hline
\texttt{- flutterapp\slash ios\slash BluetoothProvisioningService.swift} & Author & & & \\
...
\texttt{- flutterapp\slash ios\slash SwiftCameraPlatformView.swift} & Coauthor & & & Author \\
